...
async function generateAndSaveLessonContent(lesson) {
  try {
      ...
      **Task:** Generate the lesson content in **Formal Title's Language ( arabic or english or frensh (depending on title's language)) simple and comprehensive language**.
